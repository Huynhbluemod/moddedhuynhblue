...
H:AddLabel("Wellcone To Script Huynh Blue")
...
setclipboard("https://www.facebook.com/imhuynhblue")
end)

H:AddButton("Copy Youtube Huynh Blue",function()
setclipboard("https://youtube.com/@huynhbluemod?si=ETTG_cyrphG_oLaB9")
end)
...
print("Huynh Blue Load Complete")
